    ...
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      {fields && (
        <p className="text-red-500 mb-5 text-xl transition-all duration-150 ease-in text-center">
          {`Пожалуйста заполните все поля. Или введите URL адрес корректно (https://...).`}
        </p>
      )}
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
        <div className="bg-secondaryColor p-3 flex flex-0.7 w-full">
          <div className="flex justify-center items-center cursor-pointer flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            {loading && <Spinner />}
            {wrongImageType && <p>Неправильный формат изображения</p>}
            {!imageAsset ? (
              <label>
                <div className="cursor-pointer flex flex-col items-center justify-center h-full">
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <p className="text-lg">Нажмите чтобы прикрепить</p>
                  </div>
                  <p className="mt-32 text-gray-400">
                    Используйте высокое-качество JPG, SVG, PNG, GIF менее 20 MB
                  </p>
                </div>
                <input
                  type="file"
